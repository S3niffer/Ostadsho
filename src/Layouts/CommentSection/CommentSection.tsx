...
import { getAllOstadshoComment } from "../../App/Slices/OstadshoComment"
            ...
            <div className='grid grid-cols-1 gap-y-10 md:grid-cols-2 md:items-center'>
                <div className='flex flex-col gap-4 md:gap-4'>
                    <div className='flex flex-col gap-4 md:flex-row'>
                        ...
                        <div>
                            <h2 className='mb-4 font-yekaBakhHeavy text-3xl leading-7 text-darkBlack dark:text-lightWhite'>
                    ...
                    <svg
                        className='ms-auto rotate-[-134deg] fill-darkBlack dark:fill-lightWhite md:rotate-0'
                        width='81'
                        height='25'
                        viewBox='0 0 81 25'
                        fill='none'
                ...
                <div className='mx-auto w-[90%] md:w-full md:ps-12'>
                    <Swiper
                        effect={"cards"}
                        grabCursor={true}
