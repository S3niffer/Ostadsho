...
const HeroSection = () => {
    return (
        <div className='HeroSection container mx-auto mt-5 flex flex-col items-center justify-between pb-12 md:flex-row bml:mt-8 lg:flex-row-reverse'>
            <div className=''>
                <Lottie
                    animationData={HeroSEctionSvg}
                    className='mx-auto w-full -translate-y-12 2xs:-translate-y-5 md:w-[350px] lg:w-[470px] xl:w-[580px]'
                />
            </div>
            <div className='flex flex-col gap-2 px-4 text-Gray dark:text-lightWhite md:mt-8 md:px-0 bml:gap-3 lg:gap-5 xl:gap-7'>
                <span className='font-danafaBold text-lg font-[400] bml:text-[24px] lg:text-[27px] xl:text-3xl'>
                    داستان برنامه‌نویس شدنت از اینجا شروع میشه!
                </span>
                <span className='font-danafa text-sm leading-8 text-ThirdGray dark:text-lightSecondaryWhite lg:text-[18px] xl:text-xl'>
                    یادگیری برنامه‌نویسی آرزو نیست، فقط نیاز هست، تلاش و تمرین داشته باشید، بقیه‌اش با استاد شو
                </span>
                <div className='flex flex-col gap-2  font-yekaBakhBold md:flex-row'>
                    <div className='btn btn-green group relative flex items-center justify-between bg-main text-lightWhite hover:bg-light_green hover:text-main md:pe-7 md:pr-4 md:text-sm bml:px-12 bml:text-base lg:py-5 lg:pe-10 lg:pr-8 lg:text-lg '>
                        <Link
                            to='/categories/All'
                            className='mx-auto'>
                    ...
                    <div className='btn btn-green md:px-4 md:text-sm bml:px-12 bml:text-base lg:px-10 lg:py-5 lg:text-lg '>
                        <span
                            onClick={() => {
                            ...
                            className='block text-center md:flex md:place-items-center'>
                            درباره تیم استادشو
                        </span>
                    </div>
                </div>
                <ul className='mt-4 flex flex-col flex-wrap gap-y-6 font-danafaBold text-[12px] font-normal text-ThirdGray dark:text-lightSecondaryWhite xs:text-sm md:flex-row md:gap-y-8 md:text-[12px] bml:text-sm lg:text-base xl:text-lg'>
                    <li className='flex items-center md:w-1/2'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='41'
                            height='41'
                            ...
                            <circle
                                ...
                                fill='#E81C4D'
                                opacity='0.15'
                                transform='rotate(-36.651 21.416 21.552)'></circle>
                            <path
                                fill='#E81C4D'
                                fillRule='evenodd'
                    ...
                    <li className='mr-auto flex items-center md:mr-0 md:w-1/2'>
                        <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width='39'
                            height='40'
                            ...
                            <path
                                fill='#98A3B8'
                                d='M15.583 10.083a.917.917 0 000 1.834h1.834a.917.917 0 100-1.834h-1.834z'></path>
                            <path
                                fill='#98A3B8'
                                d='M19.955 6.417h-4.33a4.66 4.66 0 00-3.27 1.342 4.546 4.546 0 000 6.482c.43.426.939.763 1.5.994a4.66 4.66 0 001.77.348h4.33c.094-.542.164-1.15.212-1.833h-4.542a2.797 2.797 0 01-1.962-.805A2.747 2.747 0 0112.85 11a2.728 2.728 0 01.813-1.944 2.777 2.777 0 011.962-.806h4.542a18.41 18.41 0 00-.212-1.833z'></path>
                            <path
                                fill='#98A3B8'
                                fillRule='evenodd'
                            ...
                            <circle
                                ...
                                fill='#98A3B8'
                                opacity='0.15'
                                transform='rotate(-33.86 19.348 20.348)'></circle>
                        </svg>
                        ضمانت بازگشت وجه
                    </li>
                    <li className='flex items-center md:w-1/2'>
                        <svg
                            ...
                            <circle
                                ...
                                fill='#9018EE'
                                opacity='0.15'
                                transform='rotate(-36.651 19.72 19.887)'></circle>
                            <path
                                stroke='#9018EE'
                                strokeLinecap='round'
                                strokeLinejoin='round'
                                strokeWidth='2'
                                d='M3 13c0 2.448.132 4.346.462 5.827.326 1.47.833 2.465 1.54 3.172.706.706 1.702 1.213 3.171 1.54 1.48.328 3.38.461 5.827.461 2.448 0 4.346-.133 5.827-.462 1.47-.326 2.465-.833 3.172-1.54.706-.706 1.213-1.702 1.54-3.171.328-1.48.461-3.38.461-5.827 0-2.448-.133-4.346-.462-5.827-.326-1.47-.833-2.465-1.54-3.172-.706-.706-1.702-1.213-3.171-1.54C18.347 2.133 16.447 2 14 2c-2.448 0-4.346.132-5.827.462-1.47.326-2.465.833-3.172 1.54-.706.706-1.213 1.702-1.54 3.171C3.133 8.653 3 10.553 3 13z'></path>
                            <path
                                stroke='#9018EE'
                                strokeLinejoin='round'
                                strokeWidth='2'
                                d='M13.158 9.182l1.761-1.848a1.092 1.092 0 011.52-.052l3.219 2.934c.434.396.458 1.06.053 1.485l-1.893 1.985m-4.66-4.504l-4.87 5.106a1.037 1.037 0 00-.286.786l.2 2.945c.038.553.51.983 1.077.981l3.02-.011c.296-.001.58-.122.782-.335l4.737-4.968m-4.66-4.504l4.66 4.504'></path>
                        </svg>
                    ...
                    <li className='mr-auto flex items-center md:mr-0 md:w-1/2'>
                        <svg
                            ...
                            <path
                                ...
                                strokeLinejoin='round'
                                strokeWidth='1.385'
                                d='M13.96 6.542a7.359 7.359 0 016.502 6.493M13.96 9.814a4.087 4.087 0 013.233 3.232'></path>
                            <path
                                fillRule='evenodd'
                                stroke='#51B6FF'
                                strokeLinecap='round'
                            ...
                            <circle
                                ...
                                fill='#51B6FF'
                                opacity='0.15'
                                transform='rotate(-36.651 21.286 19.887)'></circle>
                        </svg>
                        پشتیبانی ۲۴ساعته
                    </li>
                </ul>
