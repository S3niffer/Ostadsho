...
const CoursesSection = () => {
    ...
    return (
        <div className='CoursesSection container'>
            <div className='title flex flex-col items-center justify-between gap-2 md:flex-row'>
                <div className='flex flex-col items-center gap-3 md:flex-row'>
                    <svg
                        ...
                        <g fill='#ffb726'>
                            <path
                                ...
                                transform='translate(100 -9)'></path>
                            <path
                    ...
                    <div className='text-center md:text-right'>
                        ...
                        <span className='font-yekaBakhLight text-xs uppercase tracking-[1.5px] text-ThirdGray dark:text-lightSecondaryWhite md:text-sm bml:text-base lg:text-lg'>
                ...
                <Link
                    ...
                    <div className='relative flex cursor-pointer items-center justify-between  rounded-md bg-ThirdGray py-1.5 text-center text-xs text-lightWhite transition-all duration-300 hover:bg-Gray 2xs:text-sm md:justify-center md:gap-2  md:py-2.5 bml:text-base lg:py-3 lg:text-lg'>
                        ...
                        <svg
                            ...
                            <path
                                className='fill-lightWhite group-hover:fill-main'
                                d='M18.732 36.768a2.5 2.5 0 010-3.536L32.066 19.9a2.5 2.5 0 013.535 3.536l-11.67 11.557L35.6 46.566a2.5 2.5 0 01-3.535 3.535L18.732 36.768z'></path>
                        </svg>
                    </div>
                </Link>
            </div>
