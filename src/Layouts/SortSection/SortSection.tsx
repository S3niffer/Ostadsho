...
const SortSection = ({ _sortHandler }: { _sortHandler: (sortOption: T_SortOption) => void }) => {
    const [sortOption, setsortOption] = useState<T_SortOption>()

    useEffect(() => {
        _sortHandler(sortOption)
    }, [sortOption])
    return (
                ...
                <div
                    ...
                    <svg
                        ...
                        <g clipPath='url(#clip0_3545_2017)'>
                            <path
                                fill='#596C80'
                                d='M96.865 99.127l-6.35-8.893V29.531a1.64 1.64 0 00-1.64-1.64H16.688a1.64 1.64 0 00-1.641 1.64v60.703l-6.35 8.893a1.64 1.64 0 001.33 2.592h85.509a1.65 1.65 0 001.452-.892 1.644 1.644 0 00-.123-1.7z'></path>
                            <path
                                fill='#475666'
                                d='M21.61 49.219A24.61 24.61 0 0045.972 27.89H16.688a1.64 1.64 0 00-1.641 1.64V48.3c2.135.607 4.343.916 6.562.919z'></path>
                            <path
                                fill='#F2F2F2'
                                d='M18.328 31.172h68.906v59.062H18.328V31.172z'></path>
                            <path
                                fill='#D9D9D9'
                                d='M18.328 31.172v17.8a24.15 24.15 0 003.281.247A24.61 24.61 0 0045.3 31.172H18.328z'></path>
                            <g filter='url(#filter0_i_3545_2017)'>
                                <path
                                    fill='#fff'
                                    d='M21.61 45.938c11.779 0 21.328-9.55 21.328-21.329S33.388 3.281 21.608 3.281.281 12.831.281 24.61c0 11.78 9.55 21.328 21.328 21.328z'></path>
                            </g>
                            <path
                                fill='#52AC66'
                                d='M29.172 19.406H16.047a1.64 1.64 0 00-1.64 1.64v13.126c0 .906.734 1.64 1.64 1.64h13.125a1.64 1.64 0 001.64-1.64V21.047a1.64 1.64 0 00-1.64-1.64z'></path>
                            <path
                                fill='#52AC66'
                        ...
                        <defs>
                            <filter
                                ...
                                <feBlend
                                    in2='shape'
                                    result='effect1_innerShadow_3545_2017'></feBlend>
                            </filter>
                    ...
                    <svg
                        ...
                        <defs>
                            <filter
                                ...
                                <feBlend
                                    in2='shape'
                                    result='effect1_innerShadow_3545_2076'></feBlend>
                            </filter>
