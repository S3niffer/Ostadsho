                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center gap-2'>
                                {price ? (
                                    <>
                                        {discountPercent ? (
                                            <span className='discountPrice relative select-none pt-[3px] text-sm text-FifthGray'>
                                                {(price * ((100 - discountPercent) / 100)).toLocaleString("en-us")}
                                            </span>
                                        ) : null}
                                        <span className='select-none font-danafa font-black text-Gray dark:text-lightFourthWhite xl:text-lg'>
                            ...
                            <button className='group flex place-items-center'>
                                <svg
                                    ...
                                    <path
                                        fill='#A3A3A3'
                                        className='group-hover:fill-main'
                                        d='M9.666 17.204c.052-.052.246-.272.428-.455 1.063-1.147 3.838-3.021 5.29-3.595.22-.092.778-.287 1.076-.3.286 0 .558.066.817.196.325.182.583.469.726.807.092.235.235.938.235.951.142.769.22 2.018.22 3.4 0 1.315-.078 2.513-.195 3.295-.013.013-.156.886-.311 1.185a1.63 1.63 0 01-1.44.886h-.052c-.388-.013-1.205-.352-1.205-.364-1.375-.574-4.085-2.358-5.174-3.544 0 0-.308-.305-.44-.495a1.574 1.574 0 01-.312-.95c0-.378.116-.73.337-1.017z'></path>
                                </svg>
                            </button>
                        </div>
                    </div>
                </div>
                <div className='absolute -top-9 left-0 right-0 mx-4 h-40 overflow-hidden rounded-md bg-black lg:h-32'>
                    <img
                        src={imageSrc}
                        alt='course'
                        className='h-full w-full object-cover transition-all duration-300 group-hover/Card:scale-110'
                    />
                </div>
            </div>
        </Link>
