...
const CourseCard = ({ categoryName, courseName, imageSrc, price, title, discountPercent }: T_Course) => {
    return (
        <Link to={`/${categoryName}/${courseName}`}>
            <div className="courseCard relative pt-4 px-2 md:px-0 group/Card cursor-pointer">
                ...
                <div className="absolute bg-black mx-4 -top-9 h-40 lg:h-32 rounded-md overflow-hidden left-0 right-0">
                    <img src={imageSrc} alt="course" className='object-cover w-full h-full group-hover/Card:scale-110 transition-all duration-300' />
                </div>
            </div>
        </Link>
    )
