...
type Tnavbar = { id: number, title: string, link: string }
            ...
            {item.submenu ? (
                <>
                    ...
                    <div className="submenuBg absolute w-full invisible group-hover:visible h-5">
                        <ul className="shadow-xl absolute bg-lightWhite border  border-t-4 border-transparent rounded-2xl border-t-main p-3 w-[200px] -right-3 top-44 opacity-0 -z-[1] duration-500 group-hover:z-0 group-hover:opacity-100 group-hover:visible group-hover:top-5 dark:bg-darkThirdBlack">
